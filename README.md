...
Restaurante(long id, double longitude, double latitude, String nome, int qntMesa)
...
Pedido(long id, Cliente cliente, Prato prato)
```
...
//adiciona e remove prato no cardapio do restaurante
  "gerente/prato/" POST(Prato prato, long restaurante), DELETE(long id)

//retorna o cardapio do restaurante
  "gerente/cardapio/" - GET(long restaurante)

//adiciona um funcionario
  "gerente/funcionario/" - POST(Usuario usuario)

//remove um funcionario
  "gerente/funcionario/" - DELETE(long id)
...
//Adiciona um pedido(contem uma lista de pratos) na lista de pratos para serem preparados-
  "cozinha/pedido" - POST(Prato prato, Cliente cliente, long restaurante)
